...
time for d from 0 to 2 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --20.4s
time F = det(A2)*F;--2.3s
time for d from 3 to 5 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --78s
time F = det(A3)*F; --2.4s
time for d from 6 to 8 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --44s
F
)
...
time for d from 0 to 0 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --0.17s
time F = det(B2)*F; -- 0.05
time for d from 1 to 1 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --1s
time F = det(B3)*F; --0.34
time for d from 2 to 2 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); -- 6.19
time F = det(A2)*F;--2.3s
time for d from 3 to 5 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --78s
time F = det(A3)*F; --2.5s
time for d from 6 to 8 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --45.7s
F
)
...
time for d from 0 to 0 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --0.008s
time F = det(B2)*det(C2)*F; -- 0.017
time for d from 1 to 1 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --0.15s
time F = det(B3)*det(C3)*F; --0.44
time for d from 2 to 2 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); -- 6.41
time F = det(A2)*F;--2.3s
time for d from 3 to 5 do F= sum(cc+1,k-> sum(bb+1, j-> sum(aa+1,i->x_(i,j,k)*diff(a_(i,d)*b_(j,d)*c_(k,d),F)))); --79s
